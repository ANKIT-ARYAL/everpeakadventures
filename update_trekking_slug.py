...
with open('app/trekking/[slug]/page.tsx', 'r') as f:
    content = f.read()

# 1. Remove Gallery Section at bottom
import re
# Find the Gallery Section at the bottom. It looks like:
#      {/* =========================================================
#          GALLERY
#      ========================================================= */}
...
gallery_regex = re.compile(r'\{\/\* =+[\s\n]*GALLERY[\s\n]*=+ \*\/\}.*?\{\/\* =+[\s\n]*FAQS', re.DOTALL)
content = gallery_regex.sub('{/* =========================================================\n          FAQS', content)
...
# Replace StaggerItem layout for related items.
# We will use regex to find the StaggerItem block in relatedTreks.map
...
with open('app/trekking/[slug]/page.tsx', 'w') as f:
    f.write(content)

print("Updated trekking slug")
