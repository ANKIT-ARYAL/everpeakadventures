    ...
    <div className="min-h-screen bg-[#f4f7f5] font-sans text-gray-800 py-12">
      <div className="max-w-4xl mx-auto px-5">
        ...
        <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-gray-100 relative">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start mb-8">
            ...
            <div className="flex-1 space-y-4">
              <div className="text-gray-600 text-[14px] leading-relaxed space-y-4">
                <p>
                  Welcome to Ever Peak Adventures. I&apos;m <strong>Dipesh Aryal</strong>, and trekking has been my life&apos;s work for the past 15 years. My journey in the Himalayas began from the ground level as a porter, later becoming a trekking guide, and eventually establishing Ever Peak Adventures to share authentic Himalayan experiences with travelers from around the world.
                </p>
                <p>
                  Having explored almost every trekking region of Nepal, I understand the mountains beyond the maps. From planning safe routes and logistics to creating memorable experiences, every journey is built on real field knowledge. Before founding this company, I had already helped more than <strong>10,000 travelers</strong> discover the beauty of Nepal.
                </p>
              </div>

              {/* Feature Badge Grid */}
              <div className="grid grid-cols-2 gap-2 pt-2">
                <div className="flex items-center gap-2 bg-[#f8faf9] border border-gray-100 px-3 py-2 rounded-xl text-xs font-bold text-gray-700">
          ...
          <div className="mt-8 bg-[#fffbf0] border border-[#faeacc] p-5 rounded-2xl text-gray-700 text-xs md:text-sm font-medium leading-relaxed">
          ...
          {/* Email / Signature Bar */}
          <div className="pt-8 mt-8 border-t border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
