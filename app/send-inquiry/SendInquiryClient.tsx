...
export default function SendInquiryClient({ trips, logoImage }: Props) {
  ...
  const handleCountryChange = (option: { name: string; value: string; dialCode: string }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-md text-gray-800">
      <Toaster position="top-center" />
      ...
      {/* Main Container Card */}
      <div className="-mt-10 pb-24 relative z-20 px-5 lg:px-20">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <select 
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white font-medium text-md text-gray-700 focus:outline-none focus:border-[#24a0ed]"
              >
                {trips.map(t => (
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="px-4 py-2.5 bg-white border border-gray-200 hover:bg-gray-50 font-bold text-gray-700 rounded-full flex items-center gap-2 shrink-0 transition-colors shadow-sm text-md"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-md focus:outline-none focus:border-[#24a0ed]"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {mounted ? (
                  ...
                  <div className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 text-gray-400 text-md">
                    Loading countries...
                  </div>
                )}
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="p-3 rounded-lg border border-gray-200 bg-gray-50/40 space-y-1">
                  ...
                  <NumberInput type="number" min={0} name="adultMale" value={form.adultMale} onChange={handleChange} className="w-full font-bold text-md bg-white border border-gray-200 rounded px-2.5 py-1.5" />
                </div>
                <div className="p-3 rounded-lg border border-gray-200 bg-gray-50/40 space-y-1">
                  <span className="text-[10px] text-gray-400 font-bold block">Adult Female</span>
                  <NumberInput type="number" min={0} name="adultFemale" value={form.adultFemale} onChange={handleChange} className="w-full font-bold text-md bg-white border border-gray-200 rounded px-2.5 py-1.5" />
                </div>
                <div className="p-3 rounded-lg border border-gray-200 bg-gray-50/40 space-y-1">
                  <span className="text-[10px] text-gray-400 font-bold block">Child Male</span>
                  <NumberInput type="number" min={0} name="childMale" value={form.childMale} onChange={handleChange} className="w-full font-bold text-md bg-white border border-gray-200 rounded px-2.5 py-1.5" />
                </div>
                <div className="p-3 rounded-lg border border-gray-200 bg-gray-50/40 space-y-1">
                  <span className="text-[10px] text-gray-400 font-bold block">Child Female</span>
                  <NumberInput type="number" min={0} name="childFemale" value={form.childFemale} onChange={handleChange} className="w-full font-bold text-md bg-white border border-gray-200 rounded px-2.5 py-1.5" />
                </div>
              </div>
            ...
            <div className="p-4 rounded-lg bg-gray-50 border border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <span className="text-[11px] text-gray-500 text-right px-5 lg:px-20">
            ...
            <div className="flex items-center gap-2.5">
              ...
              />
              <label htmlFor="agreed" className="text-gray-600 font-medium text-md">
            ...
            <button 
              type="submit"
              disabled={submitting}
              className="w-full bg-[#112233] hover:bg-[#24a0ed] text-white font-bold py-3.5 rounded-lg uppercase tracking-wider text-md transition-colors shadow-sm disabled:opacity-50"
            >
