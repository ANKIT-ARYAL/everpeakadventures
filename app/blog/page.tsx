              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1 justify-between">
                    <div>
                      <div className="flex items-center gap-1.5 text-md text-amber-600 font-semibold mb-2">
                    ...
                    <div className="pt-4 border-t border-gray-100">
                      <span className="inline-flex items-center gap-2 text-md font-bold text-[#222222] group-hover:text-[#24a0ed] uppercase tracking-wider transition-colors">
                        <span>Read More</span>
