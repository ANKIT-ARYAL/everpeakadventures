...
export async function PATCH(
  ...
  const unauthorized = await requireAdmin("page-categories", "edit");
  ...
  try {
    ...
    console.error("Failed to update page category:", error);
...
export async function DELETE(
  ...
  const unauthorized = await requireAdmin("page-categories", "delete");
  if (unauthorized) return unauthorized;
