...
export default function EditButton({ href, resource }: EditButtonProps) {
  ...
  return (
    <Link 
      ...
      className="inline-flex items-center gap-1 px-2.5 py-3 sm:px-2 sm:py-1.5 rounded bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors"
    >
      <Edit className="w-3.5 h-3.5" />
      <span className="hidden md:inline text-md font-medium">Edit</span>
    </Link>
  );
}