    ...
    <div className="flex flex-col gap-1.5 min-w-0">
      {items.map((child) => (
        <Link
          key={child.id}
          href={child.href}
          className="inline-flex items-center gap-1.5 text-md font-semibold text-[#24a0ed] hover:text-blue-700 bg-blue-50/50 hover:bg-blue-50 border border-blue-100 rounded-md px-2 py-1 w-fit max-w-full min-w-0"
          title={child.label}
        >
