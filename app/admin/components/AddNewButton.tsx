...
export default function AddNewButton({ href, label = 'Add New', resource }: AddNewButtonProps) {
  ...
  return (
    <Link 
      href={href}
      className="bg-[#2271b1] hover:bg-[#135e96] text-white font-bold text-md px-4 py-3 sm:py-2.5 rounded-lg shadow-sm flex items-center gap-2 transition-colors uppercase tracking-wider"
    >
