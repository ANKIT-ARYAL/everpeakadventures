...
export default async function AdminPageCategoriesPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1100px] xl:max-w-none mx-auto text-lg">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-[#f8f9fa] border-b border-gray-200">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-md text-gray-400">{root.slug} · {root._count.pages} pages · {root._count.children} sub-categories</div>
                </div>
              </div>
              <div className="flex flex-wrap items-center gap-2 shrink-0 w-full sm:w-auto">
                <Link href="/admin/pages/categories/new" className="text-indigo-600 font-bold text-md px-2 py-1.5 rounded hover:bg-indigo-50">
                  + Sub Category / Page
                </Link>
                <Link href="/admin/pages/new" className="text-indigo-600 font-bold text-md px-2 py-1.5 rounded hover:bg-indigo-50">
                  + Page
                </Link>
              ...
              <div key={child.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pl-10 pr-4 py-3 border-b border-gray-100 last:border-b-0">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-md text-gray-400">{child.slug} · {child._count.pages} pages</div>
                  </div>
                </div>
                <div className="flex flex-wrap items-center gap-2 shrink-0 w-full sm:w-auto">
                  <Link href="/admin/pages/new" className="text-indigo-600 font-bold text-md px-2 py-1.5 rounded hover:bg-indigo-50">
