    ...
    <form onSubmit={handleSubmit} className="max-w-5xl xl:max-w-none mx-auto space-y-6 text-md text-gray-800 font-sans pb-20">
      ...
      <SectionCard title="Video Banner" defaultOpen action={
        ...
        <div>
          ...
          <input type="text" name="title" value={videoBanner.title} onChange={handleVideoBannerChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="Banner title..." />
        </div>
      ...
      <SectionCard title="CTA Banner" action={
        ...
        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="title" value={ctaBanner.title} onChange={handleCtaBannerChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="CTA title..." />
        </div>
