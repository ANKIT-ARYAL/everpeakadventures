    ...
    <form onSubmit={handleSubmit} className="max-w-5xl xl:max-w-none mx-auto space-y-6 text-md text-gray-800 font-sans pb-20">
      ...
      <SectionCard title="Contact Info" defaultOpen>
        ...
        <div>
          ...
          <input type="text" name="address" value={contact.address} onChange={handleContactChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Kathmandu, Nepal" />
        </div>
        ...
        <div>
          ...
          <textarea name="mapUrl" rows={3} value={contact.mapUrl} onChange={handleContactChange} className="w-full p-3 border rounded-lg font-mono text-md focus:border-[#24a0ed] outline-none" placeholder="https://www.google.com/maps/embed?pb=..." />
        </div>
      </SectionCard>
    </form>
  );
