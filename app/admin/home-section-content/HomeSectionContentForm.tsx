    ...
    <form onSubmit={handleSubmit} className="max-w-5xl xl:max-w-none mx-auto space-y-6 text-md text-gray-800 font-sans pb-20">
      ...
      <SectionCard title="Featured Treks" defaultOpen>
        <div>
          ...
          <input type="text" name="featuredTreksLabel" value={form.featuredTreksLabel} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Top Rated Routes" />
        </div>

        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="featuredTreksTitle" value={form.featuredTreksTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Featured Trekking Packages" />
        </div>
      </SectionCard>
      ...
      <SectionCard title="Best Sellers">
        <div>
          ...
          <input type="text" name="bestSellersWatermark" value={form.bestSellersWatermark} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Trekking" />
        </div>

        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="bestSellersTitle" value={form.bestSellersTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Best Seller Trekking" />
        </div>
      ...
      <SectionCard title="Fixed Departures">
        <div>
          <label className="block font-bold mb-1">Label</label>
          <input type="text" name="fixedDeparturesLabel" value={form.fixedDeparturesLabel} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Departure Dates" />
        </div>

        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="fixedDeparturesTitle" value={form.fixedDeparturesTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Join Fixed Departure Trips" />
        </div>
      </SectionCard>
      ...
      <SectionCard title="Popular Tours">
        <div>
          <label className="block font-bold mb-1">Watermark</label>
          <input type="text" name="popularToursWatermark" value={form.popularToursWatermark} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. TOURS" />
        </div>

        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="popularToursTitle" value={form.popularToursTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Popular Tours" />
        </div>
      ...
      <SectionCard title="Explore Blogs">
        <div>
          <label className="block font-bold mb-1">Watermark</label>
          <input type="text" name="exploreBlogsWatermark" value={form.exploreBlogsWatermark} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. EXPLORE OUR BLOGS" />
        </div>

        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="exploreBlogsTitle" value={form.exploreBlogsTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Explore Our Blogs" />
        </div>
      ...
      <SectionCard title="Why Choose Us">
        <div>
          ...
          <input type="text" name="whyChooseUsBadge" value={form.whyChooseUsBadge} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Why Choose Us" />
        </div>

        <div>
          <label className="block font-bold mb-1">Title</label>
          <input type="text" name="whyChooseUsTitle" value={form.whyChooseUsTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Why Choose " />
        </div>

        <div>
          <label className="block font-bold mb-1">Title Highlight</label>
          <input type="text" name="whyChooseUsTitleHighlight" value={form.whyChooseUsTitleHighlight} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Ever Peak Adventures" />
        </div>
