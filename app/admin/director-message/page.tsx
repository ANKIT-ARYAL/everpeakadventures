      ...
      <SectionCard title="Founder Details" defaultOpen>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="founderName" value={form.founderName} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="Dipesh Aryal" />
          </div>
          <div>
            <label className="block font-bold mb-1">Founder Title</label>
            <input type="text" name="founderTitle" value={form.founderTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="Founder, Ever Peak Adventures" />
          </div>
        </div>

        <div>
          <label className="block font-bold mb-1">Founder Email</label>
          <input type="email" name="founderEmail" value={form.founderEmail} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="dipesh@everpeakadventure.com" />
        </div>
