  ...
  return (
    <div className="space-y-6 max-w-[1400px] xl:max-w-none mx-auto text-md">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link
            ...
            className="border border-gray-200 text-gray-700 font-bold text-md px-4 py-2.5 rounded-lg hover:bg-gray-50 flex items-center gap-2 uppercase tracking-wider"
          >
      ...
      <ResponsiveTable
        ...
        columnClassNames={['w-12 text-center', 'whitespace-nowrap', 'whitespace-nowrap', 'whitespace-nowrap', 'min-w-[200px] max-w-[400px]', 'whitespace-nowrap text-center', 'whitespace-nowrap text-right']}
