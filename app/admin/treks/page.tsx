  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 pb-10">
        ...
        {/* =========================================================
            DESKTOP TABLE
            Show on md and up, with horizontal scroll on smaller screens
        ========================================================= */}
...
>
              ...
              <div className="flex items-start gap-3 min-w-0">
                ...
                <img
                  ...
                  alt={trek.title}
                  className={`w-12 h-12 sm:w-14 sm:h-14 ${!trek.heroImage ? 'object-contain p-2 bg-white' : 'object-cover'} rounded-lg border border-gray-200 shadow-sm shrink-0`}
                />
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <Link
                    href={`/admin/treks/${trek.id}/edit`}
                    className="font-bold text-[#112233] hover:text-[#2271b1] block text-lg sm:text-base leading-tight break-words"
                    title={trek.title}
                  >
                    {trek.title}
                  </Link>
