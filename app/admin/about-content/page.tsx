    ...
    <form onSubmit={handleSubmit} className="max-w-5xl xl:max-w-none mx-auto space-y-6 text-md text-gray-800 font-sans pb-20">
      ...
      <SectionCard title="Hero Section" defaultOpen>
        <div>
          ...
          <input type="text" name="title" value={form.title} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="About Us" />
        </div>
        ...
        <FieldGrid cols={4}>
          <div>
            ...
            <input type="text" name="happyTravelers" value={form.happyTravelers} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="1,000+" />
          </div>
          <div>
            <label className="block font-bold mb-1">Years Experience</label>
            <input type="text" name="yearsExperience" value={form.yearsExperience} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="10+" />
          </div>
          <div>
            <label className="block font-bold mb-1">Successful Trips</label>
            <input type="text" name="successfulTrips" value={form.successfulTrips} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="100+" />
          </div>
          <div>
            <label className="block font-bold mb-1">Expert Guides</label>
            <input type="text" name="expertGuides" value={form.expertGuides} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="20+" />
          </div>
        </FieldGrid>
      </SectionCard>
      ...
      <SectionCard title="Company Culture & Vision">
        <div>
          ...
          <input type="text" name="cultureTitle" value={form.cultureTitle} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="Our Company Culture" />
        </div>
