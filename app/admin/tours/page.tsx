...
export default async function AdminToursPage() {
  ...
  return (
    <div className="w-full max-w-[1200px] xl:max-w-none mx-auto px-3 sm:px-4 lg:px-6 space-y-4 sm:space-y-6 pb-10 text-md min-w-0 overflow-x-hidden">
      ...
      <div className="hidden md:block bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden min-w-0">
        <table className="w-full text-left border-collapse table-fixed min-w-[800px]">
          <colgroup>
            ...
            <col className="w-[34%] min-w-[250px]" />
            <col className="w-[23%] min-w-[150px]" />
