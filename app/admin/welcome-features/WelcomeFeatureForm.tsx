...
export default function WelcomeFeatureForm({ initialData, isEditing = false }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-6 text-md text-gray-800 font-sans pb-20">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
        <div>
          ...
          <input type="text" name="title" required value={form.title} onChange={handleChange} className="w-full p-3 border rounded-lg text-lg font-medium focus:border-[#24a0ed] outline-none" placeholder="e.g. Local Himalayan Experts" />
        </div>
