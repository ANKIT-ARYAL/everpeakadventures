...
export default async function Page() {
  ...
  return <ContactUsClient info={{ ...(info || defaultInfo), whatsapp: settings?.whatsapp?.trim() || defaultInfo.whatsapp }} heroTitle={hero?.title} heroSubtitle={hero?.subtitle ?? undefined} heroImage={hero?.image ?? undefined} />;
}