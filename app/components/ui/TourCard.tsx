...
export default function TourCard({ tour }: { tour: TourCardProps }) {
  const displayPrice = tour.lowestPrice ?? tour.discountedPrice ?? tour.price;

  return (
    <div className="group relative aspect-[4/5] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow bg-white">
