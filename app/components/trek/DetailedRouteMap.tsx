            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-md text-gray-500">{brandTagline}</div>
                </div>
              </div>
            </div>
        ...
        <div className="relative p-4">
          ...
          {showLegend && (
            <div className="absolute top-16 left-4 z-10 bg-white/95 backdrop-blur-sm rounded-lg border border-gray-200 p-3 shadow-lg min-w-[200px] px-5 lg:px-20 max-w-[1400px] mx-auto w-full">
              ...
              <div className="font-bold text-md text-gray-700 uppercase tracking-wider mb-2 border-b pb-2">LEGEND & SYMBOLS</div>
              <div className="space-y-1.5 text-[9px] text-gray-600">
                {DEFAULT_LEGEND_ITEMS.map((item, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    {item.type === 'icon' && (
                      <div className="w-6 h-6 flex items-center justify-center text-md" style={{ color: item.color }}>
                        {item.circle && (
          ...
          <div className="absolute top-16 right-4 z-10 flex flex-col gap-1">
            <div className="bg-orange-500 text-white w-7 h-7 rounded-full flex items-center justify-center text-md font-bold shadow-lg">1</div>
            <div className="bg-red-500 text-white w-7 h-7 rounded-full flex items-center justify-center text-md font-bold shadow-lg">17</div>
          </div>
        </div>
        ...
        {showElevationProfile && elevationData.length > 0 && (
          <div className="mt-6 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-gray-200 bg-gray-50">
              <h3 className="font-bold oswald uppercase text-[#112233] text-lg">Elevation Profile</h3>
            </div>
