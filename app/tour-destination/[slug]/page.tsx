    ...
    <div className="min-h-screen bg-[#f7f9f7] font-sans text-gray-800 pb-24">
      ...
      <section className="relative py-32 bg-[#112233] text-white text-center overflow-hidden">
        ...
        <div className="relative z-10 px-5 lg:px-20">
          ...
          <p className="text-gray-200 text-lg md:text-base italic px-5 lg:px-20">
      ...
      <section className="-mt-10 relative z-20 mb-16 px-5 lg:px-20">
            ...
            {tours.map((pkg) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1 justify-between">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-3 border-t border-gray-100 text-center mb-6 text-md">
                  ...
                  <button
                    className="w-full bg-[#1c2e40] hover:bg-[#24a0ed] text-white font-bold text-md py-3 rounded-lg text-center transition-colors uppercase tracking-wider block shadow-sm"
                  >
                    View Details
                  </button>
                </div>
