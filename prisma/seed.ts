  ...
  await prisma.trek.createMany({
    data: [
      // --- EVEREST REGION ---
      {
        ...
        highlights: '<ul><li>Stand at Everest Base Camp (5,364m) at the foot of the world’s highest mountain</li><li>Summit Kala Patthar (5,545m) for panoramic sunrise views of Everest, Nuptse & Lhotse</li><li>Fly from Kathmandu to Lukla aboard a scenic mountain-bound flight</li><li>Explore the vibrant Sherpa capital of Namche Bazaar and the Khumbu region</li><li>Visit the iconic Tengboche (Dawa Chojacha) Monastery with Everest views</li><li>Cross thrilling suspension bridges over the deep Dudh Kosi river gorge</li><li>Witness close-up views of the awe-inspiring Khumbu Icefall and Glacier</li><li>Experience authentic Sherpa culture, monasteries, and mountain hospitality</li></ul>',
        inclusions: '<ul><li>All airport-hotel-airport ground transfers by private vehicle</li><li>Kathmandu – Lukla – Kathmandu domestic flight tickets with airport taxes</li><li>Three night accommodation in a comfortable Kathmandu hotel with breakfast</li><li>Accommodation at teahouses/lodges during the trek (twin sharing)</li><li>All meals (Breakfast, Lunch & Dinner) during the trekking days</li><li>Licensed, English-speaking (Sherpa) trekking guide and strong porters</li><li>Trekking permit (TIMS) and Sagarmatha National Park entry permit fees</li><li>All applicable government taxes and office service charges</li><li>Seasonal fruits as a dessert during the trek, where available</li><li>Sleeping bag and down jackets issued (returnable after the trek)</li><li>First-aid kit, Oxymeter check-up, and a hot shower when available</li></ul>',
        exclusions: '<ul><li>International flight tickets to / from Kathmandu</li><li>Personal travel, rescue, and medical insurance</li><li>Extra nights in Kathmandu or on the trek than planned itinerary</li><li>Meals in Kathmandu (Lunch & Dinner) aside from breakfast</li><li>Personal trekking equipment and baggage, any excess baggage fees</li><li>Helicopter rescue and evacuation costs</li><li>Tips for trekking staff (guide, porters, driver)</li><li>Any items & expenses not mentioned in the "Cost Includes" section</li></ul>',
        packingList: '<ul><li>Hiking / trekking boots (broken-in)</li><li>Down jacket / warm jacket</li><li>Multiple layers of warm clothing</li><li>Waterproof shell jacket & pants</li><li>Wool socks & glove liners</li><li>Sun hat, neck gator & beanie</li><li>UV sunglasses & sunscreen</li><li>Head torch with extra batteries</li><li>Water bottles (2 x 1L) & purification tabs</li><li>Personal medication & first-aid kit</li><li>Sleeping bag (rated -10°C)</li><li>Trekking poles & camel pack</li><li>Reusable water purifier & snacks</li><li>Passport, permits & travel insurance docs</li></ul>',
itinerary: [
  ...
  // Seed Tours for Nepal, Bhutan, and Tibet with full detail + relational group pricing & schedules
  await prisma.tour.deleteMany().catch(() => {});
  await prisma.tour.createMany({
    data: [
      ...
      },
      {
        ...
        heroImage: 'https://images.unsplash.com/photo-1544644181-1484b3fdfc62?q=80&w=2000&auto=format&fit=crop',
        duration: '4 Days',
        bestTime: 'Sept–June',
        destination: 'nepal',
        order: 4,
  ...
  // Fully-detailed featured tours that also include group pricing & departure schedules
  await prisma.tour.create({
    data: {
      title: 'Annapurna Region-Sightseeing Tour',
      slug: 'annapurna-region-sightseeing',
      description: 'Explore the stunning Annapurna region with breathtaking views, cultural encounters, and comfortable accommodations.',
      overview: 'The Annapurna Region-Sightseeing Tour is the perfect blend of adventure and culture. Starting from Kathmandu, this multi-day trek takes you through the heart of the Annapurna massif, offering panoramic views of the Himalayas, ancient mountain temples, and vibrant local villages. Each day is carefully planned with well-known guides to ensure a safe and memorable experience.',
      ...
      mapUrl: 'https://maps.app.goo.gl/example-annapurna',
      price: 1499,
      originalPrice: 1999,
      priceRange: 'US$ 1,499 - US$ 1,999',
      isAllInclusive: false,
      regions: ['Annapurna Region', 'All Trekking Packages'],
      focusKeyphrase: 'Annapurna Region-Sightseeing Tour',
      seoTitle: 'Annapurna Region-Sightseeing Tour - Book Today!',
      metaDescription: 'Experience the stunning Annapurna region with our comprehensive sightseeing tour. Multi-day trek through breathtaking landscapes, ancient temples, and vibrant local culture.',
      highlights: '<ul><li>Scenic flights to Pokhara & Nepal</li><li>Visit to the famous Pashupatinath Temple</li><li>Trek through the Annapurna Circuit with 5 high camps</li><li>Cultural immersion with local villages & homestays</li><li>Beautiful mountain views from Machapuchare</li><li>Traditional Nepal music & dance evenings</li><li>All meals & accommodations included</li></ul>',
      inclusions: '<ul><li>All airport transfers by private vehicle</li><li>Teahouse / lodge accommodation (twin sharing)</li><li>All meals (Breakfast, Lunch, Dinner)</li><li>Licensed English-speaking (Sherpa) trekking guide and strong porters</li><li>Trekking permit (TIMS) and Sagarmatha National Park entry permit fees</li><li>Camping equipment, sleeping bags & warm clothing</li><li>Trekking insurance (optional)</li></ul>',
      exclusions: '<ul><li>International flight tickets to / from Kathmandu</li><li>Personal travel, rescue, and medical insurance</li><li>Extras, souvenirs, tips & gratuities</li><li>Extra days due to weather or health conditions</li><li>Personal items not mentioned in the itinerary</li></ul>',
      packingList: '<ul><li>Hiking / trekking boots (broken-in)</li><li>Layered clothing (warm weather & cold nights)</li><li>Waterproof shell jacket & pants</li><li>Wool socks & glove liners</li><li>Sun hat, neck gator & beanie</li><li>UV sunglasses & sunscreen</li><li>Head torch with extra batteries</li><li>Water bottles (2 x 1L) & purification tabs</li><li>Personal medication & first-aid kit</li><li>Sleeping bag (rated -10°C)</li><li>Trekking poles & camel pack</li><li>Reusable water purifier & snacks</li><li>Passport, permits & travel insurance docs</li></ul>',
      itinerary: [
        { day: 1, title: 'Arrival in Kathmandu (1,400m)', elev: 1400, desc: 'Welcome at Kathmandu airport and transfer to the hotel. Kick-off trip briefing and gear check. Overnight at a comfortable hotel in Kathmandu.' },
        { day: 2, title: 'Fly to Pokhara (920m)', elev: 920, desc: 'Take a scenic early morning flight to Pokhara. Afternoon trek to Phewa Lake, boat ride, and evening visit to the wildlife sanctuary.' },
        { day: 3, title: 'Trek to Sarangkot & Viewpoint (3,200m)', elev: 3200, desc: 'Morning trek to Sarangkot for sunrise over the Annapurna range. Explore the wildlife sanctuary and visit the famous viewpoint pillars.' },
        { day: 4, title: 'Trek to Ghorepani (3,200m)', elev: 3200, desc: 'Follow the trail up to Ghorepani with panoramic views of the Annapurna range.' },
        { day: 5, title: 'Trek to Poon Hill & Nayapul (3,000m)', elev: 3000, desc: 'Early morning hike to Poon Hill for iconic sunrise views over the Annapurna massif.' },
        { day: 6, title: 'Trek to Muktinath & Besishahar (3,000m)', elev: 3000, desc: 'Morning hike to Muktinath temple for cultural immersion, then visit Besishahar.' },
        { day: 7, title: 'Return to Kathmandu', elev: 1400, desc: 'Transfer back to Kathmandu for departure with breathtaking memories.' },
      ],
      videoUrl: '',
      videoType: 'youtube',
      isBestSeller: true,
      ...
      groupPrices: {
        create: [
          { groupSize: '1 - 2 Pax', groupType: 'Small Group', price: 'US$ 1,499' },
          { groupSize: '3 - 5 Pax', groupType: 'Best Value', price: 'US$ 1,399' },
  ...
  await prisma.tour.create({
    data: {
      ...
      description: 'Explore the sacred Kingdom of Bhutan with breathtaking landscapes and cultural immersion.',
      overview: 'The Bhutan Adventure Tour offers a complete experience in the Kingdom of Bhutan. From the mystical Paro Valley to the vibrant Thimphu and the sacred Tigers Nest, this tour combines rich cultural heritage with unforgettable natural beauty.',
      heroImage: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800&auto=format&fit=crop',
      gallery: [
        'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=800&auto=format&fit=crop',
      ...
      destination: 'bhutan',
      primaryDestination: 'Bhutan',
      grade: 'Moderate',
      maxAltitude: '3,000 m',
      startPoint: 'Kathmandu',
      endPoint: 'Paro',
      meals: 'B.L.D',
      activity: 'Cultural Trekking & Adventure',
      groupSize: '2 - 10 Pax',
      transport: 'Private Vehicle',
      mapUrl: 'https://maps.app.goo.gl/example-bhutan',
      price: 1699,
      originalPrice: 2199,
      priceRange: 'US$ 1,699 - US$ 2,199',
      isAllInclusive: true,
      regions: ['Bhutan', 'All Trekking Packages'],
      focusKeyphrase: 'Bhutan Adventure Tour',
      seoTitle: 'Bhutan Adventure Tour - Book Today!',
      metaDescription: 'Experience the sacred Kingdom of Bhutan with breathtaking landscapes and cultural immersion. A comprehensive adventure tour through the countrys most iconic destinations.',
      highlights: '<ul><li>Sacred cultural immersion in the Kingdom of Bhutan</li><li>Buddhist monasteries & dzongs</li><li>Milky Way trekking from Paro</li><li>Traditional Bhutanese cooking class</li><li>Community homestay experience</li></ul>',
      inclusions: '<ul><li>All airport transfers by private vehicle</li><li>Teahouse accommodation (twin sharing)</li><li>All meals & cultural experiences</li><li>Licensed guide & supporting team</li><li>Traditional Bhutanese cooking demonstration</li></ul>',
      exclusions: '<ul><li>International flight tickets to / from Kathmandu</li><li>Personal travel, rescue and medical insurance</li><li>Extras, souvenirs, tips & gratuities</li><li>Personal items not mentioned in the itinerary</li></ul>',
      packingList: '<ul><li>Hiking boots (broken-in)</li><li>Layered clothing (warm weather & cold nights)</li><li>Windproof jacket</li><li>Sun hat, sunglasses & sunscreen</li><li>Waterproof jacket & pants</li><li>Trekking poles</li><li>Personal medications & first-aid kit</li><li>Passport & travel documents</li></ul>',
      itinerary: [
        { day: 1, title: 'Arrival in Paro (2,350m)', elev: 2350, desc: 'Welcome at Paro airport. Transfer to Paro and settle in. Afternoon cultural tour of Paro.' },
        { day: 2, title: 'Bumthang Day Trek (3,000m)', elev: 3000, desc: 'Morning trek to the sacred Bumthang valley. Visit the Jambay Lhakhang Drup monastery.' },
        { day: 3, title: 'Tigers Nest Monastery (3,120m)', elev: 3120, desc: 'Day trip to the iconic Paro Taktsang Monastery (Tigers Nest) with panoramic views.' },
        { day: 4, title: 'Milky Way Trek to Phobjikha', elev: 3000, desc: 'Night trek to the Phobjikha Valley for an unforgettable Milky Way trekking experience.' },
        { day: 5, title: 'Return to Paro & Cultural Activities', elev: 2350, desc: 'Morning trekking return. Explore the National Museum. Evening Bhutanese cooking class.' },
        { day: 6, title: 'Departure', elev: 2350, desc: 'Transfer to Paro airport for departure.' },
      ],
      videoUrl: '',
      videoType: 'youtube',
      isBestSeller: true,
      ...
      groupPrices: {
        create: [
          { groupSize: '1 - 2 Pax', groupType: 'Small Group', price: 'US$ 1,699' },
          { groupSize: '3 - 5 Pax', groupType: 'Best Value', price: 'US$ 1,599' },
  ...
  await prisma.tour.create({
    data: {
      ...
      description: 'Explore the spiritual heart of Tibet with the iconic Potala Palace and Himalayan views.',
      overview: 'The Classic Lhasa & Potala Palace Tour offers an unforgettable journey through the spiritual heart of Tibet. Visit the spectacular Potala Palace, explore the vibrant Lhasa streets, and enjoy breathtaking Himalayan views.',
      heroImage: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=800&auto=format&fit=crop',
      gallery: [
        'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=800&auto=format&fit=crop',
      ...
      bestTime: 'Apr–Oct',
      destination: 'tibet',
      primaryDestination: 'Tibet',
      grade: 'Moderate',
      maxAltitude: '4,000 m',
      startPoint: 'Kathmandu',
      endPoint: 'Lhasa',
      meals: 'B.L.D',
      activity: 'Cultural Trekking & Sightseeing',
      groupSize: '2 - 10 Pax',
      transport: 'Private Vehicle',
      mapUrl: 'https://maps.app.goo.gl/example-tibet',
      price: 1799,
      originalPrice: 2299,
      priceRange: 'US$ 1,799 - US$ 2,299',
      isAllInclusive: false,
      regions: ['Tibet', 'All Trekking Packages'],
      focusKeyphrase: 'Classic Lhasa & Potala Palace Tour',
      seoTitle: 'Classic Lhasa & Potala Palace Tour - Book Today!',
      metaDescription: 'Experience the spiritual heart of Tibet with the iconic Potala Palace, Lhasa streets, and breathtaking Himalayan views. A comprehensive cultural sightseeing tour.',
      highlights: '<ul><li>Visit to the Potala Palace in Lhasa</li><li>Tibetan cultural immersion & performances</li><li>Explore the monastery of Drepung</li><li>Scenic flights from Lhasa & Kathmandu</li><li>Visit to the Jokhang Temple</li></ul>',
      inclusions: '<ul><li>All airport transfers by private vehicle</li><li>Teahouse accommodation (twin sharing)</li><li>All meals & cultural experiences</li><li>Licensed Tibetan guide & supporting team</li><li>Tibetan cooking demonstration</li></ul>',
      exclusions: '<ul><li>International flight tickets to / from Kathmandu</li><li>Personal travel, rescue and medical insurance</li><li>Extras, souvenirs, tips & gratuities</li><li>Personal items not mentioned in the itinerary</li></ul>',
      packingList: '<ul><li>Hiking boots (broken-in)</li><li>Layered clothing (warm weather & cold nights)</li><li>Windproof jacket</li><li>Sun hat, sunglasses & sunscreen</li><li>Waterproof jacket & pants</li><li>Trekking poles</li><li>Personal medications & first-aid kit</li><li>Passport & travel documents</li></ul>',
      itinerary: [
        { day: 1, title: 'Arrival in Kathmandu (1,400m)', elev: 1400, desc: 'Welcome at Kathmandu airport. Trip briefing and overnight in Kathmandu.' },
        { day: 2, title: 'Fly to Lhasa (3,650m)', elev: 3650, desc: 'Morning flight to Lhasa. Afternoon visit to the Potala Palace and Jokhang Temple.' },
        { day: 3, title: 'Explore Barkhor Street & Drepung Monastery', elev: 3650, desc: 'Morning walk through the bustling Barkhor Street. Afternoon visit to Drepung Monastery.' },
        { day: 4, title: 'Lhasa Cultural Activities', elev: 3650, desc: 'Traditional Tibetan tea ceremony and cultural performances.' },
        { day: 5, title: 'Return to Kathmandu', elev: 1400, desc: 'Morning flight to Kathmandu. Afternoon leisure time.' },
        { day: 6, title: 'Departure', elev: 1400, desc: 'Transfer to Kathmandu airport for departure.' },
      ],
      videoUrl: '',
      videoType: 'youtube',
      isBestSeller: true,
      ...
      groupPrices: {
        create: [
          { groupSize: '1 - 2 Pax', groupType: 'Small Group', price: 'US$ 1,799' },
          { groupSize: '3 - 5 Pax', groupType: 'Best Value', price: 'US$ 1,699' },
...
// Seed CTA Banner Content
  ...
  await prisma.whyPageContent.create({
    data: {
      ...
      contentHtml: `
        <div class="space-y-6 text-md md:text-lg text-gray-600 leading-relaxed">
      ...
      contentHtml: `
        ...
        <div class="space-y-6 pt-4">
          ...
          <div>
            ...
            <p class="text-md text-gray-500 mt-2">We only collect information that is necessary for providing our services.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-md text-gray-500 mt-2">All third parties are required to protect your data and use it solely for service delivery.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-md text-gray-500 mt-2">You can control or disable cookies through your browser settings, though this may affect some website features.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-md text-gray-500 mt-2">To exercise these rights, please contact us directly.</p>
          </div>
          ...
          <div>
            ...
            <div class="bg-[#f8faf9] p-5 rounded-2xl border border-gray-100 space-y-3">
              ...
              <p class="text-md font-medium text-gray-700">Email: info@everpeakadventures.com</p>
              <p class="text-md font-medium text-gray-700">Location: Kathmandu, Nepal</p>
            </div>
          </div>
        </div>
      `,
